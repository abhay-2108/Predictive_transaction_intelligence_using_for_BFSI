  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 px-4 sm:px-6 lg:px-0">
      ...
      <div className="bg-black/20 backdrop-blur-sm rounded-xl border border-white/10 p-4 sm:p-6">
        ...
        <p className="text-gray-300 text-sm sm:text-base">Customize your SecureGuard AI experience</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
        ...
        <div className="bg-black/20 backdrop-blur-sm rounded-xl border border-white/10 p-4 sm:p-6">
          <div className="flex items-center mb-4 sm:mb-6">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-white">Language & Localization</h2>
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full p-3 bg-white/10 border border-white/20 rounded-lg text-white text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        ...
        <div className="bg-black/20 backdrop-blur-sm rounded-xl border border-white/10 p-4 sm:p-6">
          <div className="flex items-center mb-4 sm:mb-6">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-white">Notifications & Alerts</h2>
          </div>
        ...
        <div className="bg-black/20 backdrop-blur-sm rounded-xl border border-white/10 p-4 sm:p-6">
          <div className="flex items-center mb-4 sm:mb-6">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-white">Data & Performance</h2>
          </div>
      ...
      <div className="bg-black/20 backdrop-blur-sm rounded-xl border border-white/10 p-4 sm:p-6">
        <div className="flex items-center mb-4 sm:mb-6">
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-white">Security & Privacy</h2>
        </div>
      ...
      <div className="bg-black/20 backdrop-blur-sm rounded-xl border border-white/10 p-4 sm:p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          <div>
            ...
            <div className="p-3 bg-white/5 border border-white/10 rounded-lg text-white text-sm sm:text-base">
              Admin User
            </div>
          </div>
          <div>
          ...
          <div>
            <label className="block text-xs sm:text-sm font-medium text-gray-300 mb-2">Last Login</label>
            <div className="p-3 bg-white/5 border border-white/10 rounded-lg text-white text-sm sm:text-base break-words">
              {new Date().toLocaleString()}
            </div>
          </div>
          <div>
            <label className="block text-xs sm:text-sm font-medium text-gray-300 mb-2">Session Status</label>
            <div className="p-3 bg-white/5 border border-white/10 rounded-lg text-green-400 text-sm sm:text-base">
              Active
            </div>
          </div>
        </div>
      ...
      <div className="bg-black/20 backdrop-blur-sm rounded-xl border border-white/10 p-4 sm:p-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h3 className="text-lg font-semibold text-white mb-1 sm:mb-2">Reset Settings</h3>
            <p className="text-gray-300 text-sm sm:text-base">Restore all settings to their default values</p>
          </div>
          <button
            onClick={() => setShowResetConfirm(true)}
            className="flex items-center justify-center space-x-2 px-4 py-2 text-sm font-medium text-red-400 hover:text-red-300 hover:bg-red-500/10 rounded-lg transition-colors border border-red-500/20 self-start sm:self-auto"
          >
      ...
      {showResetConfirm && (
        <div className="fixed inset-0 z-[9999] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-gray-800 rounded-lg p-4 sm:p-6 max-w-sm w-full border border-white/20">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="flex-1 px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition-colors text-sm sm:text-base"
              >
                Cancel
              </button>
              <button
